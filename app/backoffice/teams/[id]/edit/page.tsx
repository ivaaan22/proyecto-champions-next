    ...
    <div className="max-w-lg">
      ...
      <form action={`/api/teams/${team.id}`} method="POST" className="bg-[#0a1628] border border-[#1e3a5f] rounded-2xl p-6 flex flex-col gap-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-sm text-slate-400">Vista previa del escudo</span>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input name="crest" required defaultValue={team.crest} className="bg-[#060e1e] border border-[#1e3a5f] rounded-lg px-4 py-2.5 text-sm text-slate-100 outline-none focus:border-blue-500 transition-colors" />
        </div>
